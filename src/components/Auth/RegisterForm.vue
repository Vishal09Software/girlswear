                    ...
                    <div class="p-12">
                        ...
                        <form @submit.prevent="register" class="space-y-6">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="name" v-model="name"
                                        class="w-full px-4 py-3 pl-10 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 bg-white/50"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <i
                                        class="pi pi-envelope absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input :type="showPassword ? 'text' : 'password'" id="password" v-model="password"
                                        class="w-full px-4 py-3 pl-10 pr-10 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 bg-white/50"
                            ...
                            <button type="submit"
                                class="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3.5 rounded-xl font-semibold hover:from-blue-600 hover:to-purple-700 transform hover:scale-[1.02] transition-all duration-200 shadow-lg flex items-center justify-center gap-2">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <button type="button"
                                    class="flex items-center justify-center gap-2 py-2.5 border border-gray-300 rounded-xl hover:bg-gray-50 transition duration-200">
